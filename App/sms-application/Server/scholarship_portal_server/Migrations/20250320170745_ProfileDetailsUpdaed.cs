...
{
    /// <inheritdoc />
    public partial class ProfileDetailsUpdaed : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHosteler = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    FirstGraduateFilePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SchoolType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UMIStudentNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EducationalInfo", x => x.EducationalId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AadharMobileNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HasCommunityCertificate = table.Column<bool>(type: "bit", nullable: false),
                    CommunityCertificatePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HasIncomeCertificate = table.Column<bool>(type: "bit", nullable: false),
                    IncomeCertificatePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDonePartTime = table.Column<bool>(type: "bit", nullable: false),
                    PartTimeProofFilePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IncomeCertificateIssuedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                name: "ScholarshipsInfo",
                columns: table => new
                {
                    ScholarshipInfoID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsParentDivorced = table.Column<bool>(type: "bit", nullable: false),
                    DivorcedProofFilePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsParentPhysicallyDisabled = table.Column<bool>(type: "bit", nullable: false),
                    ParentPhysicallyDisabledFilePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsReceivedAnyScholarship = table.Column<bool>(type: "bit", nullable: false),
                    ScholarshipName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ScholarshipAmountReceived = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SiblingsDetails = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StudentID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScholarshipsInfo", x => x.ScholarshipInfoID);
                });
